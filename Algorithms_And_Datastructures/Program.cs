...
namespace Algorithms_And_Datastructures
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //ICollection<int> collection = new List<int>() { 1, 1, 2, 3, 3, 4, 5, 5 };

            //foreach (var item in ReturnDuplicates.ReturnDuplicateValues(collection))
            //{
            ...
            //Console.WriteLine(IsPalindrome.IsPalindromeOrNot("pizzip"));
